...
def parse_channel_info(api_response: dict[str, any],
    ...
    try:
        ...
        raise ValueError(f"Missing expected key in API response: {e}")
    
    except Exception as e:
        raise ValueError(f"Error parsing channel info: {e}")


def parse_playlists_info(api_response: dict[str, any],
    ...
    try:
        ...
        raise ValueError(f"Error parsing playlists info: {e}")


def parse_playlist_items_info(api_response: dict[str, any],
    ...
    try:           
        ...
        raise ValueError(f"Error parsing playlist items info: {e}")


def parse_videos_info(api_response: dict[str, any],
    ...
    try:
        ...
        for item in api_response["items"]:
            ...
            video_data = video.Video(video.VideoDetails(video_id=item["id"],
                                        ...
                                        video.Statistics(view_count=int(statistics.get("viewCount", 0)),
        ...
        raise ValueError(f"Error parsing videos info: {e}")
